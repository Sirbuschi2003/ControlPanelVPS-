...
echo "==> Stop services..."
sudo systemctl stop cpanel-master cpanel-frontend
...
echo "==> Start services..."
sudo systemctl start cpanel-master cpanel-frontend
sleep 2
sudo systemctl is-active cpanel-master cpanel-frontend
echo "==> Done."
